...
;;(function( $,ebaui ) {
    ...
    ebaui.web.registerControl( 'DataGrid' );

    /** 
     *  控件全名 e.g. ebaui.web.DataGrid
     *  控件描述
     *  @class      ebaui.web.DataGrid 
     *  @memberof   ebaui.web
     *  @extends    基类
     *  @tutorial   gridview_index
     *  @param      {Object}    options     -   控件配置参数
     *  @param      {Object}    element     -   dom对象
     */
    ebaui.control( 'web.DataGrid', {
        ...
        _render : function(){
            ...
            this._updateStyleVisible();
            this._updateStyleTitle();
        },
        ...
        _initControl : function(){
            ...
            var me = this;
            var gridOpts = me.options['jqgrid'];
            me._$root.jqGrid( gridOpts );
            me._extendSelf( $.jgrid );
    ...
    $(function(){ 
        $( 'input[data-role="datagrid"]' ).datagrid();
    });
