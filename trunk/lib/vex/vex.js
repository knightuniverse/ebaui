    ...
    vexFactory = function ($) {
        ...
        return vex = {
            ...
            open: function (options) {
                ...
                options.$vexContent = $('<div id="' + options.id + '">').addClass(vex.baseClassNames.content).addClass(options.contentClassName).css(options.contentCSS).append(options.content).data({
                    vex: options
                });
